...
* **Dependencias:** Construido con la biblioteca estándar de Rust (`std::env`, `std::fs`, `std::io`) y utilizando dependencias externas como Serde, Chrono, Bcrypt y Rpassword.
